namespace FixtureBuilder.Tests.FixtureTests
{
    internal sealed class HasFieldTests
    {
        ...
        {
            var fixture = Fixture.New<FieldClass>().CreateUninitialized();
        ...
        {
            var fixture = Fixture.New<DerivedFieldClass>().CreateUninitialized();
        ...
        {
            var fixture = Fixture.New<TestClass>().CreateUninitialized();
