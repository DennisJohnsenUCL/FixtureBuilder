...
{
    internal sealed class FakerProviderTests
    {
        ...
        {
            _factory.WhenBuilding<ConstructorClass>(b => b.With<string>(f => f.Name.FirstName()));
        ...
        {
            _factory.WhenBuilding<ConstructorClass>(b => b.With<string>(f => f.Name.FirstName(), "name"));
        ...
        {
            _factory.WhenBuilding<ConstructorClass>(b => b.WithParameter<string>(f => f.Name.FirstName()));
        ...
        {
            _factory.WhenBuilding<ConstructorClass>(b => b.WithParameter<string>(f => f.Name.FirstName(), "name"));
        ...
        public void WithPropertyOrField_Faker_AppliesValue()
        {
            ...
            _factory.WhenBuilding<PropertyClass>(b => b.WithPropertyOrField<string>(f => f.Name.FirstName()));
        ...
        public void WithPropertyOrField_FakerAndName_AppliesValue()
        {
            ...
            _factory.WhenBuilding<PropertyClass>(b => b.WithPropertyOrField<string>(f => f.Name.FirstName(), "Name"));
