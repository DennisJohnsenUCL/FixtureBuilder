namespace FixtureBuilder
{
    public static class Fixture
    {
        ...
        public static IFixtureConstructor<TEntity> New<TEntity>() where TEntity : class => new Fixture<TEntity>();
        /// <summary>
        ...
        public static IFixtureConfigurator<TEntity> New<TEntity>(TEntity entity) where TEntity : class => new Fixture<TEntity>(entity);
    }
}
